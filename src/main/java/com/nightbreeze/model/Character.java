...
public class Character {
    ...
    // JavaFX Properties
    public StringProperty CharacterNameProperty() { return name; }
    ...
    public IntegerProperty temporaryHPProperty() { return temporaryHP; }
    ...
    public int getTemporaryHP() { return temporaryHP.get(); }
    ...
    public void setStrength(int score) { this.strength.set(score); }

    public int getDexterity() { return dexterity.get(); }
    public void setDexterity(int score) { this.dexterity.set(score); }

    public int getConstitution() { return constitution.get(); }
    public void setConstitution(int score) { this.constitution.set(score); }

    public int getIntelligence() { return intelligence.get(); }
    public void setIntelligence(int score) { this.intelligence.set(score); }

    public int getWisdom() { return wisdom.get(); }
    public void setWisdom(int score) { this.wisdom.set(score); }

    public int getCharisma() { return charisma.get(); }
    public void setCharisma(int score) { this.charisma.set(score); }
